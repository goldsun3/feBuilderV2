#ifndef LISTVIEWWEAPONSTATS_H
#define LISTVIEWWEAPONSTATS_H
class ListViewWeaponStats : ListViewTemplate
{
protected:
	LVCOLUMN lvc;
	LVITEM lvi;
	std::vector<std::wstring> initStats{ L"0", L"0", L"0", L"0", L"0", L"0", L"0" };
public:
